...
public class RangedSlimeAgrAppr : FSMAction
{
    ...
    public RangedSlimeAgrAppr(FSMState owner) : base(owner)
    {
    }

    public void Init(Transform target, float duration, EnemyAstar t, float slimeRange = 8f, string finishEvent = null)
    {
        this.target = target;
